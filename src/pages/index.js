...
export default function Home() {
  return (
    <>
      ...
      <TransitionEffect />
      {/* Ajout de overflow-x-hidden pour cacher les débordements horizontaux */}
      <article
        ...
        style={{ backgroundImage: "url('/background4.webp')", backgroundSize: 'cover' }} // Correction ici pour éviter les débordements
      >
        <Layout className="!pt-0 md:!pt-12 sm:!pt-8 px-6 max-w-full overflow-x-hidden">
          <div className="flex w-full items-start justify-between md:flex-col-reverse">
            ...
            {/* Left Section Text */}
            <div className="flex w-2/2 max-w-full flex-col items-start self-center lg:w-full lg:text-center lg:items-center lg:px-8 ml-auto">
              <AnimatedText
                text="Sophie Labyt."
                ...
                <div className="flex items-center mb-4">
                  <Link
                    ...
                    className={`flex items-center rounded-lg border-2 border-solid bg-dark p-2.5 px-6 text-lg font-semibold
                      ...
                      md:p-2 md:px-4 md:text-base sm:px-3 sm:text-sm`}
                    download
                  >
